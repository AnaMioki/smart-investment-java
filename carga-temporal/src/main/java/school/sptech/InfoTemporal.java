...
public class InfoTemporal {
    ...
    public Double getPartrimonioLiquido() { return partrimonioLiquido; }
    public Double getPatrimonioLiquidoAcao() { return patrimonioLiquidoAcao; }
    public Integer getMultiploSetorial() { return multiploSetorial; }
    public Double getRentabilidadeAnual() { return rentabilidadeAnual; }
    public Double getInfoTemporalcol() { return infoTemporalcol; }
    public Double getPrecoSobreValorPatrimonial() { return precoSobreValorPatrimonial; }
    public Double getEBTDA() { return EBTDA; }
    public Double getDRE() { return DRE; }
