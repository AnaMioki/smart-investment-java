...
import school.sptech.controllers.ConexaoBanco;
...
public class TratarExcel {
    ...
    public Integer retonaMultiploSetoria(String setor) {
        ...
        switch (setor.trim()) {
            ...
            case "Fios e Tecidos":
                return 6;
            case "Brinquedos e Jogos":
                return 5;
            case "Produtos para Construção":
                return 7;
            ...
            case "Mineração":
                return 7;
            case "Intermediários Financeiros":
                return 10;
            case "Produtos Diversos":
                return 6;
            case "Transporte Hidroviário":
                return 7;
            case "Construção Pesada":
                return 8;
            case "Exploração de Imóveis":
                return 7;
            case "Equipamentos de Construção e Agrícolas":
                return 9;
            case "Outros":
                return 5;
            case "Medicamentos":
            ...
            case "Máquinas e Equipamentos":
                return 9;
            case "Holdings Diversificadas":
                return 10;
            case "Material Rodoviário":
                return 9;
            case "Papel e Celulose":
                return 7;
            case "Vestuário e Calçados":
                return 8;
            case "Automóveis e Motocicletas":
                return 9;
            case "Bicicletas":
                return 6;
            case "Produção de Eventos e Shows":
                return 5;
            case "Engenharia Consultiva":
                return 6;
            case "Material Aeronáutico e Defesa":
                return 10;
            case "Equipamentos de Saúde":
                return 11;
            case "Hotelaria":
                return 8;
            ...
            case "Computadores e Equipamentos":
                return 10;
            case "Intermediação Imobiliária":
                return 7;
            case "Açucar e Alcool":
                return 8;
            case "Transporte Rodoviário":
                return 7;
            case "Transporte Aéreo":
                return 6;
            case "Exploração de Rodovias":
                return 10;
